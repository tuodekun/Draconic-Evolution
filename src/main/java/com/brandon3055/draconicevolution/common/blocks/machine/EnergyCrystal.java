...
public class EnergyCrystal extends BlockDE implements IHudDisplayBlock {
                ...
                switch (tile.facing) {
                    case 0:
                        return AxisAlignedBB
                                .getBoundingBox(x + 0.37F, y + 0.59F, z + 0.37F, x + 0.63F, y + 1.0F, z + 0.63F);
                    case 1:
                        return AxisAlignedBB
                                .getBoundingBox(x + 0.37F, y + 0.0F, z + 0.37F, x + 0.63F, y + 0.41F, z + 0.63F);
                    case 2:
                        return AxisAlignedBB
                                .getBoundingBox(x + 0.37F, y + 0.37F, z + 0.59F, x + 0.63F, y + 0.63F, z + 1.0F);
                    case 3:
                        return AxisAlignedBB
                                .getBoundingBox(x + 0.37F, y + 0.37F, z + 0.0F, x + 0.63F, y + 0.63F, z + 0.41F);
                    case 4:
                        return AxisAlignedBB
                                .getBoundingBox(x + 0.59F, y + 0.37F, z + 0.37F, x + 1.0F, y + 0.63F, z + 0.63F);
                    case 5:
                        return AxisAlignedBB
                                .getBoundingBox(x + 0.0F, y + 0.37F, z + 0.37F, x + 0.41F, y + 0.63F, z + 0.63F);
                }
            }
        }
    ...
    public TileEntity createTileEntity(World world, int metadata) {
        return metadata == 0 || metadata == 1 ? new TileEnergyRelay(metadata)
                : metadata == 2 || metadata == 3 ? new TileEnergyTransceiver(metadata - 2)
