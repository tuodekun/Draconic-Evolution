package com.brandon3055.draconicevolution.brandonscore.client.gui.guicomponents;
...
public abstract class GUIBase extends GuiContainer {
    ...
    protected void mouseClickMove(int x, int y, int button, long time) {
        ...
        // if (collection.isMouseOver(x - this.guiLeft, y - this.guiTop)) collection.mouseDrag(x - this.guiLeft, y -
        // this.guiTop, button, time);
    }
